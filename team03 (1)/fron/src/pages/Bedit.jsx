		...
		<div class="container mt-3">
			...
			<form>
				...
				<div class="mb-3 mt-3">
					...
					<textarea type="text" class="form-control h-50" rows="10" placeholder="내용을 입력하세요." name="content"></textarea>
				</div>
				<div class="d-flex">
					<div class="p-2 flex-fill d-grid">
						<a href="./board_view.html" class="btn btn-primary">저장</a>
					</div>
					<div class="p-2 flex-fill d-grid">
						<a href="./board_view.html" class="btn btn-primary">취소</a>
					</div>
				</div>
			</form>
		</div>

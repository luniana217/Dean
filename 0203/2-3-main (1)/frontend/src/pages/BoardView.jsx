...
const BoardView = () =>{
	...
	useEffect(()=>{
		...
		const data ={"no":1, "title":"Team1 프로젝트","content": "내용을 작성해주세요","name": "장태원"}
		setData(data)
	},[])
        ...
        <div className="container mt-3">
			...
			<div className="d-flex">
				<div className="p-2 flex-fill d-grid">
					<button type="button" className="btn btn-primary"onClick={()=>navigate(`/board_edit/${no}`)}>수정</button>
				</div>
				<div className="p-2 flex-fill d-grid">

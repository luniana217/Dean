...
models = [
  "llama3.2:3b", "gemma3:4b", "gemma4:e4b", "gpt-oss:20b", "qwen3:8b" ,"qwen3.5:latest"
]
embed_models = [
...
def main():
  ...
  # # step03.run()
  # print("Step 4 실행: Ollama Embedding(임베딩) 모델과 RAG(Retrieval-Augmented Generation, 검색 증강 생성)" llm으로 학습한거 외에 간단한 정보를 학습 시키고 싶을때 하는거)
  # step04.run(models[4])
